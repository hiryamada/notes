...
AIは、機械学習モデルを利用して実装される（機械学習モデルは、AIの基盤となる）。
...
- 人工知能: 1950年代に登場したアイデア
- 機械学習: 1980年代に登場した技法。AIに含まれる。
...
※本コース「AI-102」では、Azure OpenAI Serviceの概要のみ解説する。現在、このサービスを集中的に学習できる（ハンズオンが含まれる）Microsoftの公式トレーニングコースは提供されていない。
