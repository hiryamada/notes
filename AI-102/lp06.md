...
通常、チャットボットの開発には「Bot Framework SDK」（ライブラリ）、「Bot Framework Composer」（ツール）「Bot Framework Emulator」（ツール）などを使用する。
...
これらについて詳しくは、別の（この後の）ラーニングパスで解説。
...
英語版の手順書（ブラウザの翻訳機能で日本語化して閲覧できます）
