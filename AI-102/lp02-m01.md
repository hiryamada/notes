...
※本トレーニングでは詳しく取り上げないが、意思決定のためのレコメンデーションを生成する「[Decision API](https://learn.microsoft.com/ja-jp/azure/architecture/data-guide/cognitive-services/decision-applied-ai)」や、生成的 AI モデルを活用できる「[Azure OpenAI Service](https://learn.microsoft.com/ja-jp/azure/cognitive-services/openai/overview)」も、Cognitive Servicesの一部である。
...
- 「言語サービス」の無料リソースを1つ、「音声サービス」の無料サービスを1つ、「資格サービス」の無料リソースを1つ・・・といった作成は可能。
...
- Cognitive Servicesのリソースを作成し、それを削除すると、「削除されたリソース」に移動される。
- 48時間以内であれば復旧が可能。
...
※「Cognitive Servicesマルチアカウント」や「Cognitive Search」ではなく「Cognitive Services」を選ぶ。
...
- [ラボ01 Cognitive Servicesを使用する(言語の検出)](lab01cs.md)
