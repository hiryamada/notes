...
- 1日目
  - ラボ1 Prepare for an AI development project
  - ラボ2 Explore models and evaluate performance
  - ラボ3 Create a generative AI chat app
  - ラボ4 Create a generative AI app that uses your own data 
  - ラボ5 Apply content filters to prevent the output of harmful content
- 2日目
  - ラボ6 Build AI agents with portal and VS Code
  - ラボ7 Use a custom function in an AI agent
  - ラボ8 Develop an AI agent with Model Context Protocol (MCP) tools
  - ラボ9 Integrate an AI agent with Foundry IQ
