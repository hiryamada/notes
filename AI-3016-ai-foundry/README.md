...
- 2 Microsoft Foundry ポータルでモデル カタログからモデルを選択してデプロイする 
  - lab 1 Choose and deploy a language model (JA) / 言語モデルを選択してデプロイする
- 3 Microsoft Foundry SDK を使用して AI アプリを開発する 
  - lab 2 Create a generative AI chat app (JA) / 生成AIチャットアプリを作成する
- 4 Microsoft Foundry で言語モデル アプリを開発するためのプロンプト フローの概要
- 5 Microsoft Foundry を使用して独自のデータを使用して RAG ベースのソリューションを開発する
  - lab 3: Create a generative AI app that uses your own data (JA) / 独自のデータを活用する生成AIアプリを作成する
- 6 Microsoft Foundry を使用して言語モデルを微調整する
- 7 Microsoft Foundry で責任ある生成 AI ソリューションを実装する
  - lab 4: Apply content filters to prevent the output of harmful content (JA) / 有害なコンテンツの出力を防ぐためにコンテンツフィルターを適用する
- 8 Microsoft Foundry ポータルで生成 AI のパフォーマンスを評価する
  - lab 5: Evaluate generative AI model performance (JA) / 生成AIモデルの性能を評価する
